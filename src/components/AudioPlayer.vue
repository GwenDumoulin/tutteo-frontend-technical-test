...
const tracks = [
  {
    ...
    audioUrl: require('../assets/amalgam-217007.mp3'),
  },
  {
    title: 'Flow',
    artist: 'Loksii',
    ...
    audioUrl: require('../assets/flow-211881.mp3'),
  },
  {
    ...
    audioUrl: require('../assets/creative-technology-showreel-241274.mp3'),
  },
  {
    ...
    audioUrl: require('../assets/in-slow-motion-inspiring-ambient-lounge-219592.mp3'),
  },
  {
    ...
    audioUrl: require('../assets/lazy-day-stylish-futuristic-chill-239287.mp3'),
  },
  {
    ...
    audioUrl: require('../assets/night-detective-226857.mp3'),
  },
  {
    ...
    audioUrl: require('../assets/nightfall-future-bass-music-228100.mp3'),
  },
  {
    ...
    audioUrl: require('../assets/no-place-to-go-216744.mp3'),
  },
  {
    title: 'Soulsweeper',
    artist: 'ItsWatR',
    ...
    audioUrl: require('../assets/soulsweeper-252499.mp3'),
  },
];
